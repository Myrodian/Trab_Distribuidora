...
CREATE TABLE IF NOT EXISTS `Distribuidora`.`Fornecedor` (
  ...
  INDEX `fk_Fornecedor_Rua1_idx` (`Rua_id` ASC) ,
...
CREATE TABLE IF NOT EXISTS `Distribuidora`.`Funcionario` (
  ...
  INDEX `fk_Funcionario_Rua1_idx` (`Rua_id` ASC) ,
  ...
  CONSTRAINT `fk_Funcionario_Cargo1`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Funcionario_Rua1`
    FOREIGN KEY (`Rua_id`)
    REFERENCES `Distribuidora`.`Rua` (`id`)
    ON DELETE RESTRICT
    ON UPDATE CASCADE)
...
-- -----------------------------------------------------
-- Table `Distribuidora`.`Pedido`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `Distribuidora`.`Pedido` ;

CREATE TABLE IF NOT EXISTS `Distribuidora`.`Pedido` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `Distribuidora`.`Entrega` (
  ...
  INDEX `fk_Entrega_Pedido1_idx` (`Pedido_id` ASC) ,
  UNIQUE INDEX `id_UNIQUE` (`id` ASC) ,
  ...
  CONSTRAINT `fk_Entrega_Pedido1`
    ...
    REFERENCES `Distribuidora`.`Pedido` (`id`)
    ON DELETE RESTRICT
    ON UPDATE CASCADE)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `Distribuidora`.`Produto_has_Pedido`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `Distribuidora`.`Produto_has_Pedido` ;

CREATE TABLE IF NOT EXISTS `Distribuidora`.`Produto_has_Pedido` (
  `Produto_id` INT UNSIGNED NOT NULL,
  `Pedido_id` INT UNSIGNED NOT NULL,
...
-- -----------------------------------------------------
-- Table `Distribuidora`.`Pessoa_has_Fornecedor`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `Distribuidora`.`Pessoa_has_Fornecedor` ;

CREATE TABLE IF NOT EXISTS `Distribuidora`.`Pessoa_has_Fornecedor` (
  `Pessoa_id` INT UNSIGNED NOT NULL,
  `Fornecedor_id` INT UNSIGNED NOT NULL,
