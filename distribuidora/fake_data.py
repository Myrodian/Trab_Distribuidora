...
def generate_data():
    ...
    if not read_data('SELECT * FROM entrega'):
        command = (
            ...
            '(347, "2025-05-26 20:15:00", 13, 8), '
            '(185, NULL, 2, 9), '
            '(921, "2024-10-01 14:30:00", 4, 10), '
            '(578, "2025-06-05 09:45:00", 6, 11), '
            '(337, NULL, 13, 12), '
            '(404, "2023-03-20 16:05:00", 13, 13), '
            '(810, NULL, 4, 14), '
            '(690, "2024-05-02 18:40:00", 13, 15), '
            '(205, "2023-12-14 13:55:00", 13, 16), '
            '(754, NULL, 2, 17), '
            '(146, "2025-02-24 11:50:00", 13, 18), '
            '(829, NULL, 6, 19), '
