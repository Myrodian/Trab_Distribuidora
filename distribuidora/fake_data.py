...
def generate_data():
    ...
    if not read_data('SELECT id FROM entrega'):
        command = (
            'INSERT INTO Entrega (numero_endereco, data_entrega, status, observacoes, Funcionario_id, Cliente_id) VALUES '
            '(738, "2025-06-01 08:12:00", "entregue", "Entrega realizada com sucesso", 2, 1), '
            '(512, "2025-06-03 15:47:00", "pendente", NULL, 4, 2), '
            '(264, "2025-06-04 09:33:00", "em trânsito", NULL, 6, 3), '
            '(883, "2025-06-06 18:20:00", "entregue", "Cliente ausente, reagendado", 13, 4), '
            '(199, "2025-06-08 07:25:00", "entregue", NULL, 2, 5), '
            '(411, "2025-06-11 13:55:00", "pendente", NULL, 4, 6), '
            '(620, "2025-06-13 10:02:00", "entregue", "Produto avariado", 6, 7), '
            '(347, "2025-06-15 19:44:00", "entregue", NULL, 13, 8), '
            '(185, "2025-06-19 08:30:00", "pendente", NULL, 2, 9), '
            '(921, "2025-06-21 14:05:00", "entregue", NULL, 4, 10), '
            '(578, "2025-06-23 09:18:00", "entregue", NULL, 6, 1), '
            '(337, "2025-06-25 12:45:00", "em trânsito", NULL, 13, 2), '
            '(404, "2025-06-27 16:12:00", "entregue", NULL, 2, 3), '
            '(810, "2025-06-30 07:50:00", "pendente", "Problemas na rota", 4, 4), '
            '(690, "2025-07-02 18:08:00", "entregue", NULL, 6, 5), '
            '(205, "2025-07-05 13:22:00", "entregue", NULL, 13, 6), '
            '(754, "2025-07-08 10:35:00", "pendente", NULL, 2, 7), '
            '(146, "2025-07-10 11:17:00", "entregue", NULL, 4, 8), '
            '(829, "2025-07-12 17:40:00", "em trânsito", NULL, 6, 9), '
            '(312, "2025-07-15 08:05:00", "entregue", NULL, 13, 10)'
        )
        execute_command(command)
